      ...
      <div className="option--container fadeEffect">
        ...
        <Suspense fallback={<NProgress />}>
           ...
           <div id="input--form--field">
             ...
             <small>When your account is private, only people you approve can see your photos, music and videos on Twixie. Your existing followers won't be affected.</small>
              </div>
            ...
            <div id="input--form--field">
             ...
             <small>Allow accounts you follow and anyone you message to see when you were last active on Twixie app. When this is turned off, you won't be able to see the activity status of other accounts.</small>
              </div>
