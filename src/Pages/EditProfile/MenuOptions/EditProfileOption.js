...
const EditProfileOption = (props) => {
    ...
    if(Object.keys(formState).length > 0){
           isFormValid = Object.keys(formState).every(item => formState[item]) && Object.keys(formState).some(item => formState[item] !== receivedData?.profileInfo?.[item]);
    }
    ...
    <Auxiliary>
                ...
                <div className="user--pic--container flex-column">
                    ...
                    !receivedData?.userAvatarUrl && 
                        <button onClick={() => changePhoto()} className="change__prof__pic">
