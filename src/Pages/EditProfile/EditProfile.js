              ...
              <div className="edit--box">
                <ul className="flex-column left--side">
                  {this.state.sideMenuOptions &&
                    ...
                    this.state.sideMenuOptions.filter((k) => ((receivedData?.profileInfo?.registrationMethod !== "email" || receivedData?.uid === "ysDvCWDFljMb4AKzqvtK4mANp6i2") ? (k.id !== "Change_Password_or_Email") : k)).map((item, i) => (
                      <MenuOption
