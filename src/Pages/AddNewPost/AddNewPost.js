      ...
      if (this.state.insertedCaption !== "") {
        if (this.state.contentName !== "") {
          this.state.posts.unshift({
            caption: this.state.insertedCaption,
            ...
            <div className="post--uploading--card flex-column">
              <div className="showing--upladed--content">
                {this.state.uploading ? (
                  ...
                  <video src={this.state.contentURL} controls>
                    {" "}
                  </video>
                ) : null}
              </div>
                ...
                {!this.state.uploading ? (
                  <div>
                    <textarea
                      ...
                      value={this.state.insertedCaption}
                      onChange={(e) =>
                        this.setState({ insertedCaption: e.target.value })
                      }
                    />
                    <input
                      type="text"
